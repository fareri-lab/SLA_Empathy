...
function RepeatExampleLoopLoopBegin(RepeatExampleLoopLoopScheduler) {
  ...
  for (const thisRepeatExampleLoop of RepeatExampleLoop) {
...
function Self_TaskLoopLoopBegin(Self_TaskLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSelf_TaskLoop of Self_TaskLoop) {
...
function RunLoopLoopBegin(RunLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisRunLoop of RunLoop) {
...
function FriendLoopLoopBegin(FriendLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisFriendLoop of FriendLoop) {
...
function Friend_TaskLoopLoopBegin(Friend_TaskLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisFriend_TaskLoop of Friend_TaskLoop) {
...
function OtherLoopLoopBegin(OtherLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisOtherLoop of OtherLoop) {
...
function Other_TaskLoopLoopBegin(Other_TaskLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisOther_TaskLoop of Other_TaskLoop) {
...
function Pre_PracticeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Pre_PracticeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Practice_CrossRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Practice_CrossComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Self_StartRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Self_StartComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Self_TaskRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Self_TaskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Self_ISIRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Self_ISIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Self_OutcomeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Self_OutcomeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Self_ITIRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Self_ITIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SelfblockRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SelfblockComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Self_ratingscaleRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Self_ratingscaleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function VersionInitateRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of VersionInitateComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Friend_StartRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Friend_StartComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Friend_TaskRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Friend_TaskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Friend_ISIRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Friend_ISIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Friend_OutcomeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Friend_OutcomeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Friend_ITIRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Friend_ITIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function FriendblockRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of FriendblockComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Friend_ratingscaleRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Friend_ratingscaleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Other_StartRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Other_StartComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Other_TaskRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Other_TaskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Other_ISIRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Other_ISIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Other_OutcomeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Other_OutcomeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Other_ITIRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Other_ITIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function OtherblockRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of OtherblockComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Other_ratingscaleRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Other_ratingscaleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function V2_2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of V2_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function End_ITIRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of End_ITIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
